		...
		<div class="container">
			...
			<div class="row">
				<div class="col-md-7">
					<a href="moviedetail.php?MovieName=Parmanu">
						<img class="img-responsive img-hover poster" src="img/post-parmanu.jpg" alt="Parmanu">
					</a>
				</div>
				<div class="col-md-5">
					<h3>Parmanu</h3>
			...
			<div class="row">
				<div class="col-md-7">
					...
					<img class="img-responsive img-hover poster" src="img/Masaan_poster.jpg" alt="Masaan">
					</a>
				</div>
				<div class="col-md-5">
					<h3>Masaan</h3>
